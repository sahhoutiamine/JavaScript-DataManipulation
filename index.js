  ...
  destinations: [
    {
      ...
      distance: "384,400 km",
      description:
        "Experience low-gravity walking and stunning Earth views from our lunar habitat",
      capacity: 20,
      available: true,
    ...
    },
    {
      ...
      distance: "225M km",
      description:
        "The ultimate red planet adventure with extended stay in our advanced habitat",
      capacity: 12,
      available: true,
      features: [
    ...
    },
    {
      ...
      distance: "408 km",
      description:
        "Orbital research station experience with zero-gravity experiments",
      capacity: 8,
      available: false,
    ...
    },
    {
      ...
      distance: "261M km",
      description:
        "Floating habitats in the upper atmosphere with breathtaking views",
      capacity: 15,
      available: true,
    ...
    },
    {
      ...
      distance: "628M km",
      description:
        "Explore the icy moon with potential for life beneath the surface",
      capacity: 6,
      available: true,
    ...
    },
    {
      ...
      distance: "1.2B km",
      description:
        "Visit the only moon with a dense atmosphere and liquid lakes",
      capacity: 8,
      available: true,
...
console.log(spaceData);
let destinationsData = spaceData.destinations;
let bookingsData = spaceData.bookings;
let usersData = spaceData.users;
let packagesData = spaceData.packages;
...
function countTotalDestinations() {
  ...
  return destinationsData.length;
}
...
function getAvailableDestinations() {
  // let availableDestinations = destinationsData.filter((destination) => {
...
function countTotalPassengers() {
  ...
  for (let i = 0; i < bookingsData.length; i++) {
    totalPass += bookingsData[i].passengers.length;
  }
...
function findMostExpensiveBooking() {
  let max = bookingsData[0].totalPrice;
  let ind = 0;
  for (let i = 1; i < bookingsData.length; i++) {
    if (max < bookingsData[i].totalPrice) {
      max = bookingsData[i].totalPrice;
      ind = i;
    }
  }
  return bookingsData[ind];
}
...
function findUserWithMostBookings() {
  let max = usersData[0].totalBookings;
  let ind = 0;
  for (let i = 1; i < usersData.length; i++) {
    if (max < usersData[i].totalBookings) {
      max = usersData[i].totalBookings;
      ind = i;
    }
  }
  return usersData[ind];
}
...
function getAllPassengerNames() {
  let names = [];
  let pass = bookingsData[i].passengers;
  for (let i = 0; i < bookingsData.length; i++) {
...
async function testAllChallenges() {
  ...
  console.log(
    "13. March bookings:",
    filterBookingsByDate("2024-03-01", "2024-04-01")
  );
...
console.log(
  "Pro tip: Open browser console and type testAllChallenges() to check your work!"
);
